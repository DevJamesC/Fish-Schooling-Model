...
spd=agt.perception;                      %fox migration speed in units per iteration - this is equal to the food search radius
% hungry=1;
 eaten=0;
...
%         agt.position=npos;               %move agent to position of this rabbit
